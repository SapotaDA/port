...
function App() {
  return (
    <div className="h-screen w-screen bg-[#020617] noise">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 h-16 bg-slate-950/80 backdrop-blur-lg border-b border-sky-500/10 z-40 flex items-center px-8">
        <div className="max-w-7xl mx-auto w-full flex justify-between items-center">
          <h1 className="text-xl font-bold text-white tracking-tight">AARAV<span className="text-sky-400">.DEV</span></h1>
